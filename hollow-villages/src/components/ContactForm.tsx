...
/**
 * The projects a visitor can address a message to. Shared across every Futures
 * Atlas site (the index and each project) so the dropdown reads the same
 * everywhere. Each contact page passes `defaultProject` to pre-select the one
...
export function ContactForm({
  defaultProject = "The Hollow Villages",
}: {
