...
export const metadata: Metadata = {
  title: "Contact — The Hollow Villages",
  description:
    "Get in touch with The Hollow Villages, a project of the Futures Atlas by Frond Studio — collaborations, commissions, questions.",
};
      ...
      <Container>
        <header className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl font-mono text-[14px] leading-[1.7] text-ink-70">
            The Hollow Villages is a project of the Futures Atlas, by Frond
            Studio in partnership with the Centre for Quantum &amp; Society, to
            make the futures we might live in visible, tangible, and open to
            debate.
          </p>
        ...
        <div className="mt-12 max-w-2xl">
          <ContactForm defaultProject="The Hollow Villages" />
        </div>
      </Container>
    </section>
  );
