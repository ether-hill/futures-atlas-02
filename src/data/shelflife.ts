...
export const STOCK: FutureProduct[] = [
  ...
  },
  {
    ...
    year: "2040",
    price: "€129",
    line: "A classic locket for keeping family moments close.",
    image: "/shelflife/ilocket.jpg",
    listing: {
      delivery: "Standard delivery included. Delivered in 2–4 days.",
      specs: [
        { label: "Display", value: "1.8-inch round colour screen with 400 × 400 resolution" },
        { label: "Case", value: "32 mm polished stainless steel locket with silver finish" },
        { label: "Chain", value: "55 cm stainless steel chain with matching finish" },
        { label: "Battery", value: "Up to 14 days per charge; USB-C charging" },
        {
          label: "Photos & video",
          value:
            "Stores up to 500 photos and 50 short video clips; family members can add new moments remotely",
        },
      ],
      reviews: [
        {
          stars: 5,
          title: "Beautiful little thing",
          body: "Looks like a proper locket when it's closed. I gave it to my mum with a few videos of the grandchildren already loaded. She was very happy with it.",
        },
        {
          stars: 4,
          title: "Works well",
          body: "The picture is surprisingly clear for something this small. My family can add photos from home and they show up automatically. Battery lasts around two weeks.",
        },
        {
          stars: 3,
          title: "Nice, but the chain",
          body: "The locket itself is lovely and works as expected. The chain is a little short for me, so I replaced it with a longer one.",
        },
      ],
      qa: [
        {
          q: "Can it show videos as well as photos?",
          a: "Yes. iLocket can display photos and short video clips. Videos play when you open the locket and tap the screen.",
        },
      ],
    },
  },
