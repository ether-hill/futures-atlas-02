...
/**
 * The evidence contract — Finding, Source, the tiers, the chart rules — lives
 * in `report-types.ts` and is shared with every other Atlas report. It is
 * re-exported here so this file stays the one import a consumer of THIS report
 * needs, and so the rules cannot be quietly re-interpreted per report.
 */
