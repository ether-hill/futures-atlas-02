...
import {
  ...
  FIELD_DYNAMICS_REEL, TURBULENCE_POST, SHIFTCOOL_REEL, SOLOCOOL_REEL, JONES_SLIME_REEL,
} from "./fields";
...
export const POSTS: Post[] = [
  ...interleave(
    [FIELD_DYNAMICS_REEL, SHIFTCOOL_REEL, JONES_SLIME_REEL, HOME_REEL, SOLOCOOL_REEL, UNDERGROUND_REEL, STACK_REEL, BREAK_REEL, ...REEL_POSTS],
