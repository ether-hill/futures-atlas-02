...
void main() {
    ...
    <nav class="fa-shell__right" aria-label="Project">
      ...
      <a class="fa-shell__link" href="/contact?project=${encodeURIComponent(n.name)}">Contact</a>
    </nav>`,document.body.insertBefore(r,document.body.firstChild);const s=r.querySelector(".fa-shell__crumb"),o=r.querySelector(".fa-shell__current"),a=r.querySelector(".fa-shell__menu"),l=c=>{o.setAttribute("aria-expanded",String(c)),a.hidden=!c};o.addEventListener("click",c=>{c.stopPropagation(),l(a.hidden)}),document.addEventListener("mousedown",c=>{s.contains(c.target)||l(!1)}),document.addEventListener("keydown",c=>{c.key==="Escape"&&l(!1)})}jM({name:"Quantum Sandbox",path:"/quantum-sandbox"});const sd=document.getElementById("app");if(!sd)throw new Error("missing #app");new GM(sd).boot();
