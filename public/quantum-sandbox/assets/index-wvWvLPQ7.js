...
#define LOW_PRECISION`),t}function Gw(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===yh?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===mv?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===yn&&(t="SHADOWMAP_TYPE_VSM"),t}function Ww(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Zi:case Ji:t="ENVMAP_TYPE_CUBE";break;case Ws:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Xw(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Ji:t="ENVMAP_MODE_REFRACTION";break}return t}function qw(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Sh:t="ENVMAP_BLENDING_MULTIPLY";break;case Uv:t="ENVMAP_BLENDING_MIX";break;case Nv:t="ENVMAP_BLENDING_ADD";break}return t}function jw(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function $w(n,t,e,i){const r=n.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Gw(e),c=Ww(e),u=Xw(e),h=qw(e),p=jw(e),m=Nw(e),_=Fw(s),v=r.createProgram();let f,d,S=e.glslVersion?"#version "+e.glslVersion+`
