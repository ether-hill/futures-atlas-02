...
export const ROLES: Role[] = [
  ...
  // ── quote cards (a different flavour — real on-the-record predictions) ──────
  {
    ...
    cards: [
      ...
      { id: "quo-3", claim: "It is our job to create computing technology such that nobody has to program — kids needn't learn to code.", verdict: "contested", note: "World Government Summit, Feb 2024. AI coding tools exploded, but skilled-engineer demand hasn't collapsed.", attribution: "Jensen Huang, Nvidia CEO", source: { label: "Tom's Hardware", url: "https://www.tomshardware.com/tech-industry/artificial-intelligence/jensen-huang-advises-against-learning-to-code-leave-it-up-to-ai" } },
      { id: "quo-4", claim: "In 2025 we'll have an AI that can effectively be a sort of mid-level engineer that writes code.", verdict: "contested", note: "Said on Joe Rogan, Jan 2025. AI now writes lots of code, but autonomous 'mid-level engineers' replacing staff hasn't materialized at scale.", attribution: "Mark Zuckerberg, Meta CEO", source: { label: "IT Pro", url: "https://www.itpro.com/software/development/a-sign-of-things-to-come-in-software-development-mark-zuckerberg-says-ai-will-be-doing-the-work-of-mid-level-engineers-this-year-and-hes-not-the-only-big-tech-exec-predicting-the-end-of-the-profession" } },
      { id: "quo-5", claim: "AI will probably be smarter than any single human next year. By 2029, smarter than all humans combined.", verdict: "contested", note: "Posted on X in March 2024. The 2025 'smarter than any human' mark slipped; Musk later pushed it to '<2 years' — his timelines routinely slide.", attribution: "Elon Musk, Tesla / xAI CEO", source: { label: "Musk on X (Mar 2024)", url: "https://x.com/elonmusk/status/1767738797276451090" } },
      { id: "quo-6", claim: "Autonomous driving is a solved problem — we're less than two years from complete autonomy, safer than humans.", verdict: "unlikely", note: "Said in 2016 — one of a decade of 'next year' robotaxi promises. As of 2026 Teslas still aren't unsupervised Level 5; the deadline keeps moving.", attribution: "Elon Musk, Tesla CEO", source: { label: "Predictions for autonomous Tesla vehicles", url: "https://en.wikipedia.org/wiki/List_of_predictions_for_autonomous_Tesla_vehicles_by_Elon_Musk" } },
      ...
      { id: "quo-8", claim: "Within 10 years AI will replace many doctors and teachers — humans won't be needed for most things.", verdict: "contested", note: "Said on The Tonight Show, Feb 2025, calling it the era of 'free intelligence.' A 2035 bet; doctors and teachers remain firmly in demand for now.", attribution: "Bill Gates, Microsoft co-founder", source: { label: "CNBC", url: "https://www.cnbc.com/2025/03/26/bill-gates-on-ai-humans-wont-be-needed-for-most-things.html" } },
      { id: "quo-9", claim: "Before worrying about AI smarter than us, we need a design for a system smarter than a house cat. We're nowhere near.", verdict: "contested", note: "Meta's chief AI scientist, 2024 — the prominent contrarian: LLMs are an 'off-ramp' to human-level AI, not the road. Hotly disputed by rivals.", attribution: "Yann LeCun, Meta Chief AI Scientist", source: { label: "LeCun on X (May 2024)", url: "https://x.com/ylecun/status/1791890883425570823" } },
    ],
  },
];
