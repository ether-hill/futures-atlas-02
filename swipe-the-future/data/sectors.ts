...
export const SECTORS: Sector[] = [
  ...
  },
  {
    ...
    cards: [
      { id: "t1", claim: "Driverless passenger trains have carried the public with no staff on board.", short: "Driverless passenger trains", verdict: "already", correction: "Authored as 1981 France", note: "Kobe's Port Island Line opened driverless in 1981; Lille's VAL followed in 1983, the first automated network under a major city. Trains and stations are unstaffed.", source: { label: "Railway Technology, Lille VAL", url: "https://www.railway-technology.com/projects/lille_val/" }, checked: CHECKED },
      ...
      { id: "t10", claim: "An autonomous vehicle company has been criminally prosecuted over a passenger death.", short: "AV firm prosecuted over a death", verdict: "notyet", correction: "Authored as 'no prosecution'", note: "Prosecutors cleared Uber over the 2018 Tempe death and charged its safety driver. Cruise took a deferred prosecution and a $500,000 fine, but for lying about a crash.", source: { label: "US DOJ, Cruise false report agreement", url: "https://www.justice.gov/usao-ndca/pr/cruise-admits-submitting-false-report-influence-federal-investigation-and-agrees-pay" }, checked: CHECKED },
    ],
  },
  {
