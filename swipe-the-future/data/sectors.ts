...
export const SECTORS: Sector[] = [
  {
    ...
    cards: [
      ...
      { id: "h8", claim: "A national medical board has granted an AI system a licence to practise.", short: "AI licensed to practise medicine", verdict: "notyet", note: "The traffic runs the other way: US states have started legislating to stop AI practising a licensed health profession at all.", bigLabel: "Boards that have licensed one", big: "None", lede: "No medical board in any jurisdiction has licensed an AI to practise.", source: { label: "CNN, state AI therapy laws", url: "https://www.cnn.com/2025/08/27/health/ai-therapy-laws-state-regulation-wellness" }, checked: CHECKED },
      { id: "h9", claim: "A national health service has replaced its radiologists with AI.", short: "Radiologists replaced by AI", verdict: "notyet", note: "Demand rose over the same decade, pay reached about $571,000, and he has conceded the timing.", bigLabel: "Health services that have", big: "None", lede: "Hinton told people to stop training radiologists in 2016.", source: { label: "New Republic / NYT", url: "https://newrepublic.com/article/187203/ai-radiology-geoffrey-hinton-nobel-prediction" }, checked: CHECKED },
