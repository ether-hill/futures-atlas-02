...
//
// House style for a claim, learned the hard way:
//   1. It has to be answerable wrong. "Quantum computers could help design better
//      batteries" is unfalsifiable, so everyone swipes TRUE and learns nothing.
//      Cut "could", "may", "might", "has the potential to".
//   2. Anchor it in time. "Today", "already", "by 2030", "this decade". A claim
//      with no clock in it is usually a claim with no answer.
//   3. Give it something checkable: a number, a named body, a shipped thing.
//   4. One sentence, under 25 words, plain language, no em dashes.
//
...
export const SECTORS: Sector[] = [
  {
    ...
    cards: [
      ...
      { id: "prog-6", claim: "Data stolen from your systems today is already exposed to a quantum computer that does not exist yet.", verdict: "already", note: "This is the live 'harvest now, decrypt later' threat: long-lived secrets taken today are already exposed to a future quantum machine.", source: S.nistNsa },
    ],
  },
  {
    ...
    cards: [
      ...
      { id: "des-6", claim: "By 2027, AI will have materially disrupted more than 200,000 US entertainment jobs.", verdict: "likely", note: "A 2024 industry study projected 200,000+ US entertainment jobs materially disrupted by generative AI within three years.", source: S.cvl },
    ],
  },
  {
    ...
    cards: [
      ...
      { id: "law-3", claim: "US federal courts are on track to write a sanctions rule aimed specifically at AI-fabricated filings.", verdict: "likely", note: "Legal observers expect the Advisory Committee on Civil Rules to propose a separate rule for AI-hallucination sanctions.", source: S.natLawReview },
      ...
      { id: "law-6", claim: "Your firm's privileged files will be readable retroactively once quantum computers mature.", verdict: "likely", note: "'Harvest now, decrypt later' applies to any long-confidential record. Legal files are a prime target.", source: S.nistNsa },
    ],
  },
  {
    id: "money", kind: "sector", name: "Money & Crypto", blurb: "Q-Day · wallets · ECDSA",
    cards: [
      { id: "cry-1", claim: "About a quarter of all Bitcoin sits in addresses a future quantum computer could empty.", verdict: "likely", note: "Around 25% of all BTC, roughly 4 million coins, sit in addresses with exposed public keys, the part a quantum attacker could target.", source: S.deloitte },
      ...
      { id: "cry-5", claim: "Even once Bitcoin patches itself, moving every vulnerable coin to safety would take over a year.", verdict: "likely", note: "Migrating all vulnerable coins is estimated at ~76 days of dedicated blockspace, and ~2 years at realistic network usage.", source: S.kent },
  ...
  },
  {
    ...
    cards: [
      ...
      { id: "ene-2", claim: "By 2030, AI data centres will use as much power as a mid-sized country.", verdict: "likely", note: "Estimates add ~200 TWh of annual demand globally, comparable to the entire electricity use of Poland or Vietnam.", source: S.goldmanIea },
      { id: "ene-3", claim: "The US grid can be built out fast enough to keep up with data-centre demand this decade.", verdict: "unlikely", note: "Roughly $720B of grid investment is needed by 2030, and interconnection queues already run past five years. The bottleneck is real.", source: S.grid },
      { id: "ene-4", claim: "Designing batteries and catalysts is a nearer-term use for quantum computers than breaking encryption.", verdict: "likely", note: "Materials and chemistry simulation is one of the most credible near-term uses of quantum computing.", source: S.qroadmaps },
  ...
  // ── additional categories (research-sourced; see git log) ──────────────────
  {
    ...
    cards: [
      ...
      { id: "doc-5", claim: "By 2035, AI will have cut the number of doctors a hospital needs.", verdict: "contested", note: "Strong diagnostic results exist, but clean vignettes flatter AI; real clinics face messy data, liability and integration gaps. Experts split on the net effect.", source: { label: "Univ. of Minnesota Medical School", url: "https://med.umn.edu/news/ai-healthcare-new-research-shows-promise-and-limitations-physicians-working-gpt-4-decision-making" } },
  ...
  },
  {
    ...
    cards: [
      ...
      { id: "acc-5", claim: "By 2030, AI will make the judgment calls in tax strategy and audit, not just the data entry.", verdict: "unlikely", note: "AI automates data entry and reconciliation, but ambiguous transactions, regulatory nuance, ethics and advisory judgment still require accountants.", source: { label: "Stanford GSB", url: "https://www.gsb.stanford.edu/insights/ai-reshaping-accounting-jobs-doing-boring-stuff" } },
