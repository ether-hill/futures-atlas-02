...
// were authored separately from the sourcing, so a handful of reveals were
// corrected against what the source actually says; those corrections are marked
// with a CORRECTED comment so they can be checked rather than taken on trust.
...
export interface Card {
  ...
  short: string;
  verdict: Verdict;
  note: string; // grounded reveal, ≤ ~35 words
...
export const SECTORS: Sector[] = [
  {
    ...
    cards: [
      { id: "h1", claim: "Software has been reading cervical smear slides in real clinics.", short: "Software reading smear slides", verdict: "already", note: "Since 1995, when PAPNET won FDA premarket approval for rescreening Pap smears. It is generally counted as the first AI-enabled medical device anywhere.", source: { label: "FDA premarket approval, PAPNET (1995)", url: "https://link.springer.com/article/10.1007/s10462-023-10588-z" }, checked: CHECKED },
      { id: "h2", claim: "A regulator has approved an AI to diagnose patients with no doctor reading the result.", short: "AI diagnosis, no doctor", verdict: "already", note: "In 2018 the FDA cleared IDx-DR for diabetic retinopathy. The result goes straight into the patient's file with no clinician interpreting the image.", source: { label: "FDA / Digital Diagnostics", url: "https://www.digitaldiagnostics.com/fda-permits-marketing-of-lumineticscore-formerly-known-as-idx-dr-for-automated-detection-of-diabetic-retinopathy-in-primary-care/" }, checked: CHECKED },
      { id: "h3", claim: "A health authority has recommended AI read chest X-rays instead of a human.", short: "AI reads chest X-rays officially", verdict: "already", note: "The WHO has recommended computer-aided detection as an alternative to a human reader for TB screening since 2021, for people aged 15 and over.", source: { label: "WHO, computer-aided detection for TB screening (2021)", url: "https://www.who.int/publications/b/79103" }, checked: CHECKED },
      { id: "h4", claim: "A multi-centre study has found doctors got worse at their own job after months of using AI.", short: "Doctors deskilled by AI", verdict: "already", note: "Endoscopists' unassisted adenoma detection fell from 28.4% to 22.4% after routine AI exposure. Published in Lancet Gastroenterology & Hepatology, 2025.", source: { label: "Lancet Gastro & Hep, endoscopist deskilling (2025)", url: "https://www.thelancet.com/journals/langas/article/PIIS2468-1253(25)00289-4/abstract" }, checked: CHECKED },
      { id: "h5", claim: "It has been made illegal in some places for an AI to act as someone's therapist.", short: "AI therapy banned somewhere", verdict: "already", note: "CORRECTED (authored as 'seven jurisdictions'). Four US states ban it outright, Illinois first in August 2025, with penalties up to $15,000 a violation. Four more regulate without banning.", source: { label: "CNN, state AI therapy laws", url: "https://www.cnn.com/2025/08/27/health/ai-therapy-laws-state-regulation-wellness" }, checked: CHECKED },
      { id: "h6", claim: "A medical device that runs on a large language model has been approved for sale.", short: "LLM medical device approved", verdict: "notyet", note: "Not one. The FDA has authorised roughly 1,500 AI-enabled devices and none of them is generative or built on a large language model.", source: { label: "FDA, AI-enabled medical device list", url: "https://www.fda.gov/medical-devices/software-medical-device-samd/artificial-intelligence-enabled-medical-devices" }, checked: CHECKED },
      { id: "h7", claim: "A drug designed by AI has completed late-stage trials and been approved for general prescription.", short: "AI-designed drug approved", verdict: "notyet", note: "Not yet. Insilico's lung-fibrosis drug reached positive phase 2a results in Nature Medicine in 2025, a first, but nothing AI-designed is approved.", source: { label: "Insilico / Nature Medicine (2025)", url: "https://www.prnewswire.com/news-releases/insilico-medicine-announces-nature-medicine-publication-of-phase-iia-results-evaluating-rentosertib-the-novel-tnik-inhibitor-for-idiopathic-pulmonary-fibrosis-ipf-discovered-and-designed-with-a-pioneering-ai-approach-302472070.html" }, checked: CHECKED },
      { id: "h8", claim: "A national medical board has granted an AI system a licence to practise.", short: "AI licensed to practise medicine", verdict: "notyet", note: "Nowhere, in any jurisdiction. The traffic is the other way: US states have started legislating to stop AI practising a licensed health profession at all.", source: { label: "CNN, state AI therapy laws", url: "https://www.cnn.com/2025/08/27/health/ai-therapy-laws-state-regulation-wellness" }, checked: CHECKED },
      { id: "h9", claim: "A national health service has replaced its radiologists with AI.", short: "Radiologists replaced by AI", verdict: "notyet", note: "None has. Hinton told people to stop training radiologists in 2016; demand rose over the same decade, pay reached about $571,000, and he conceded the timing.", source: { label: "New Republic / NYT", url: "https://newrepublic.com/article/187203/ai-radiology-geoffrey-hinton-nobel-prediction" }, checked: CHECKED },
      { id: "h10", claim: "Europe's dedicated AI rules for medical devices have taken effect.", short: "EU AI device rules in force", verdict: "notyet", note: "Deferred. The EU pushed high-risk obligations to December 2027 for standalone systems and August 2028 for AI inside regulated products such as medical devices.", source: { label: "EU AI Act, agreed delay to high-risk rules", url: "https://www.hlc.com/en/publications/eu-legislators-agree-to-delay-for-highrisk-ai-rules" }, checked: CHECKED },
    ],
  },
  {
    id: "transport", kind: "sector", name: "Transport", blurb: "Driverless everything · and the bits that stayed human",
    cards: [
      { id: "t1", claim: "Driverless passenger trains have carried the public with no staff on board.", short: "Driverless passenger trains", verdict: "already", note: "CORRECTED (authored as 1981 France). Kobe's Port Island Line opened driverless in 1981; Lille's VAL followed in 1983, the first automated network under a major city. Trains and stations are unstaffed.", source: { label: "Railway Technology, Lille VAL", url: "https://www.railway-technology.com/projects/lille_val/" }, checked: CHECKED },
      { id: "t2", claim: "Long-distance trucks have carried commercial freight on public roads with nobody in the cab.", short: "Driverless trucks on highways", verdict: "already", note: "Aurora opened driverless freight between Dallas and Houston on 1 May 2025, the first heavy-truck self-driving service on public roads.", source: { label: "Aurora Innovation", url: "https://ir.aurora.tech/news-events/press-releases/detail/119/aurora-begins-commercial-driverless-trucking-in-texas-ushering-in-a-new-era-of-freight" }, checked: CHECKED },
      { id: "t3", claim: "A peer-reviewed study has found driverless cars have fewer injury crashes than human drivers.", short: "Driverless cars crash less, proven", verdict: "already", note: "A 2025 study across 56.7 million driverless miles found Waymo's injury-crash rate significantly below the human benchmark.", source: { label: "Traffic Injury Prevention (2025)", url: "https://www.tandfonline.com/doi/full/10.1080/15389588.2025.2499887" }, checked: CHECKED },
      { id: "t4", claim: "More than eight million deliveries have been completed by robots driving themselves along pavements.", short: "Eight million robot deliveries", verdict: "already", note: "Starship passed eight million autonomous deliveries by April 2025, with more than 2,700 robots across 270+ locations.", source: { label: "The Robot Report", url: "https://www.therobotreport.com/starship-technologies-surpasses-8m-autonomous-deliveries/" }, checked: CHECKED },
      { id: "t5", claim: "Container terminals have moved cargo with no human operating the cranes.", short: "Automated container terminals", verdict: "already", note: "Since 1993, when Rotterdam's ECT Delta opened as the world's first automated terminal, running driverless AGVs and automated stacking cranes around the clock.", source: { label: "ECT Hutchison Ports, 30 years of the first automated terminal", url: "https://www.ect.nl/en/news/fast-forward/30-years-ago-ect-opened-very-first-automated-terminal-world" }, checked: CHECKED },
      { id: "t6", claim: "A car has been sold to the public that needs no human supervision at any point.", short: "Car needing no supervision", verdict: "notyet", note: "No. The one eyes-off system sold to US drivers, Mercedes Drive Pilot, was Level 3, worked only in narrow conditions, and was dropped from the 2026 S-Class for a supervised system.", source: { label: "InsideEVs, Mercedes Level 3 withdrawn", url: "https://insideevs.com/news/784404/mercedes-level-3-drive-pilot-canceled/" }, checked: CHECKED },
      { id: "t7", claim: "Cargo ships have crossed an ocean with no crew on board.", short: "Crewless cargo ship crossing", verdict: "notyet", note: "Not a cargo ship. The uncrewed Mayflower, a small research vessel, crossed the Atlantic in 2022, and was towed the last 25 miles.", source: { label: "Maritime Executive, Mayflower crossing", url: "https://maritime-executive.com/article/mayflower-autonomous-ship-completes-historic-atlantic-crossing" }, checked: CHECKED },
      { id: "t8", claim: "A country has set a date to phase out human-driven cars.", short: "Date set to end human driving", verdict: "notyet", note: "Proposed, legislated nowhere. Sixty-odd countries have set dates to phase out petrol and diesel cars. None has set one for the driver.", source: { label: "Science and Engineering Ethics, should manual driving be outlawed", url: "https://link.springer.com/article/10.1007/s11948-020-00190-9" }, checked: CHECKED },
      { id: "t9", claim: "A commercial passenger flight has operated with no pilot on board.", short: "Pilotless passenger flight", verdict: "notyet", note: "None certified. The work is all cargo first: Reliable Robotics is aiming at 2028 certification, and Merlin flies its system with a human safety pilot.", source: { label: "IEEE Spectrum, autonomous plane certification", url: "https://spectrum.ieee.org/autonomous-planes-certification" }, checked: CHECKED },
      { id: "t10", claim: "An autonomous vehicle company has been criminally prosecuted over a passenger death.", short: "AV firm prosecuted over a death", verdict: "notyet", note: "CORRECTED (authored as 'no prosecution'). Prosecutors cleared Uber over the 2018 Tempe death and charged its safety driver. Cruise took a deferred prosecution and a $500,000 fine, but for lying about a crash.", source: { label: "US DOJ, Cruise false report agreement", url: "https://www.justice.gov/usao-ndca/pr/cruise-admits-submitting-false-report-influence-federal-investigation-and-agrees-pay" }, checked: CHECKED },
    ],
  },
  {
    id: "work", kind: "sector", name: "Work & employment", blurb: "Strikes · firings · the laws that did and didn't arrive",
    cards: [
      { id: "w1", claim: "Screenwriters have gone on strike and won contract limits on studios using AI.", short: "Writers struck, won AI limits", verdict: "already", note: "A 148-day strike in 2023. The agreement holds that AI cannot be considered a writer and AI material cannot undercut a writer's credit.", source: { label: "Writers Guild of America, AI provisions", url: "https://www.wga.org/contracts/know-your-rights/artificial-intelligence" }, checked: CHECKED },
      { id: "w2", claim: "Workers have been dismissed by an automated system, with no manager involved in the decision.", short: "Fired by an algorithm", verdict: "already", note: "Documents from 2019 showed Amazon's tracking system generating warnings and terminations from productivity metrics with no supervisor input, roughly 300 people at one site. Amazon says managers can override.", source: { label: "MIT Technology Review", url: "https://www.technologyreview.com/2019/04/26/1021/amazons-system-for-tracking-its-warehouse-workers-can-automatically-fire-them/" }, checked: CHECKED },
      { id: "w3", claim: "A study of millions of freelance job listings found design work dropped after AI image tools arrived.", short: "Design listings fell after AI", verdict: "already", note: "Across five million Upwork postings, graphic-design listings fell about 17% once the image generators launched.", source: { label: "Hui, Reshef and Zhou, 2024", url: "https://questromworld.bu.edu/platformstrategy/wp-content/uploads/sites/49/2024/06/PlatStrat2024_paper_119.pdf" }, checked: CHECKED },
      { id: "w4", claim: "A randomised trial has found experienced software developers work slower with AI tools than without.", short: "Devs slower with AI, trialled", verdict: "already", note: "METR ran one in 2025. Experienced developers were 19% slower with the tools, while believing they had been 20% faster.", source: { label: "METR, July 2025", url: "https://metr.org/blog/2025-07-10-early-2025-ai-experienced-os-dev-study/" }, checked: CHECKED },
      { id: "w5", claim: "Employers have been banned by law from using AI to infer their workers' emotions.", short: "Emotion AI banned at work", verdict: "already", note: "In force across the EU since 2 February 2025 as an outright prohibited practice, not a regulated one. Fines reach €35 million or 7% of global turnover.", source: { label: "European Commission, AI Act", url: "https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai" }, checked: CHECKED },
      { id: "w6", claim: "A national government has introduced a tax on companies that replace workers with AI.", short: "Tax on replacing workers", verdict: "notyet", note: "CORRECTED (authored as 'enacted nowhere'). South Korea trimmed a tax break for automation investment in 2017, widely miscalled a robot tax. No direct tax exists, and the European Parliament voted one down.", source: { label: "Stephensons, South Korea's robot tax", url: "https://www.stephensons.co.uk/site/news_and_events/uptodatenews/south-korea-introduces-worlds-first-robot-tax" }, checked: CHECKED },
      { id: "w7", claim: "A company of significant size has appointed an AI system as a director with legal authority.", short: "AI appointed company director", verdict: "notyet", note: "No jurisdiction permits it. Deep Knowledge Ventures' VITAL was given board observer status in 2014 precisely because Hong Kong law requires a natural person.", source: { label: "Governance Institute of Australia", url: "https://www.governanceinstitute.com.au/news_media/ai-in-the-boardroom-could-robots-soon-be-running-companies/" }, checked: CHECKED },
      { id: "w8", claim: "A national labour force survey has recorded a fall in overall employment attributed to AI.", short: "Employment fall blamed on AI", verdict: "notyet", note: "None has. Displacement shows up by occupation in forecasts like the WEF's declining-roles list, not as a fall in the headline employment figures.", source: { label: "WEF Future of Jobs 2025", url: "https://www.weforum.org/publications/the-future-of-jobs-report-2025/" }, checked: CHECKED },
      { id: "w9", claim: "A country has legislated a shorter standard working week and named AI productivity as the reason.", short: "Shorter week credited to AI", verdict: "notyet", note: "Nowhere. Twelve US states have proposed four-day-week bills and none has passed, and none of the trials rests its case on AI.", source: { label: "Harvard Business Review, what's stopping the 4-day week", url: "https://hbr.org/2026/04/whats-stopping-the-4-day-workweek" }, checked: CHECKED },
      { id: "w10", claim: "A trade union has won an agreement banning AI from a job category outright.", short: "Union ban on AI in a job", verdict: "notyet", note: "None. The agreements that exist require bargaining before deployment, restrict named uses and protect against AI-driven layoffs. They constrain; they do not ban.", source: { label: "Partnership on AI, three union agreements", url: "https://partnershiponai.org/these-3-agreements-secured-ai-protections-for-30000-union-workers/" }, checked: CHECKED },
    ],
  },
  {
    id: "law", kind: "sector", name: "Law & justice", blurb: "Sanctions · settlements · what a machine may decide",
    cards: [
      { id: "l1", claim: "Lawyers have been fined by courts for citing cases an AI invented.", short: "Lawyers fined for AI citations", verdict: "already", note: "Hundreds of filings since 2023, up sevenfold in 2025, with sanctions running from $1,000 to more than $30,000.", source: { label: "Bloomberg Law · court records", url: "https://news.bloomberglaw.com/" }, checked: CHECKED },
      { id: "l2", claim: "An AI company has agreed to pay authors more than a billion dollars for training on their books without permission.", short: "Billion-dollar authors settlement", verdict: "already", note: "Anthropic agreed $1.5 billion in 2025, approved in 2026: the largest copyright class settlement on record, about $3,000 a book across roughly 482,000 works.", source: { label: "Courthouse News Service", url: "https://www.courthousenews.com/anthropic-to-pay-1-5-billion-copyright-settlement-to-authors-publishers/" }, checked: CHECKED },
      { id: "l3", claim: "A national judiciary has issued official guidance telling judges they may use AI chatbots in their work.", short: "Judges told they may use AI", verdict: "already", note: "England and Wales, 12 December 2023. It permits summarising and drafting, warns against legal research, and bars putting anything confidential into a public chatbot.", source: { label: "Courts and Tribunals Judiciary, AI guidance", url: "https://www.judiciary.uk/wp-content/uploads/2023/12/AI-Judicial-Guidance.pdf" }, checked: CHECKED },
      { id: "l4", claim: "A country has run entire court proceedings online with AI assisting the judges, for years.", short: "Court systems online with AI", verdict: "already", note: "China opened its first internet court in Hangzhou in August 2017. Filing to judgment happens online, with AI assistants added from 2019.", source: { label: "ABA Journal, China's internet courts", url: "https://www.abajournal.com/magazine/article/china-all-virtual-specialty-internet-courts" }, checked: CHECKED },
      { id: "l5", claim: "Landlords using a shared algorithm to set rents have been sued for price-fixing.", short: "Rent algorithm sued for price-fixing", verdict: "already", note: "The US Justice Department and eight states sued RealPage in August 2024. It settled in 2025 with limits on the data the algorithm may use and no admission.", source: { label: "Wilson Sonsini, DOJ settles the RealPage case", url: "https://www.wsgr.com/en/insights/doj-settles-its-algorithmic-price-fixing-case-against-realpage.html" }, checked: CHECKED },
      { id: "l6", claim: "An AI system has been granted a licence to practise law.", short: "AI licensed to practise law", verdict: "notyet", note: "Nowhere. The live legal question runs the other way, whether a chatbot giving legal answers is already the unauthorised practice of law.", source: { label: "Thomson Reuters Institute, AI and unauthorized practice of law", url: "https://www.thomsonreuters.com/en-us/posts/government/ai-impacts-unauthorized-practice-of-law/" }, checked: CHECKED },
      { id: "l7", claim: "An AI has sat as a judge in a binding court proceeding.", short: "AI sat as a judge", verdict: "notyet", note: "It has not. China runs whole court systems where AI assists the judge and speeds the paperwork, but the decision stays with the judge.", source: { label: "ABA Journal, China's internet courts", url: "https://www.abajournal.com/magazine/article/china-all-virtual-specialty-internet-courts" }, checked: CHECKED },
      { id: "l8", claim: "An AI system has been granted legal personhood in any jurisdiction.", short: "AI granted legal personhood", verdict: "notyet", note: "None. Several US states are going the opposite way, with bills to bar courts from recognising personhood for an AI at all.", source: { label: "NPR, states considering bans on AI legal personhood", url: "https://www.npr.org/2026/05/11/nx-s1-5798754/several-states-considering-ban-on-legal-personhood-for-ai" }, checked: CHECKED },
      { id: "l9", claim: "A country has made AI-assisted legal research mandatory in public defence.", short: "AI research mandated in defence", verdict: "notyet", note: "Nowhere. AI is spreading through access-to-justice work by adoption and pilot, not by mandate, and courts keep insisting on human verification.", source: { label: "Thomson Reuters Institute, AI-powered access to justice", url: "https://www.thomsonreuters.com/en-us/posts/government/ai-impacts-unauthorized-practice-of-law/" }, checked: CHECKED },
      { id: "l10", claim: "A conviction has been overturned because evidence turned out to be AI-generated.", short: "Conviction overturned over AI evidence", verdict: "notyet", note: "Not yet. Courts are wrestling with how to authenticate video at all, and deepfake challenges are being raised, but no appellate reversal has turned on it.", source: { label: "National Center for State Courts, AI-generated evidence", url: "https://www.ncsc.org/resources-courts/ai-generated-evidence-threat-public-trust-courts" }, checked: CHECKED },
    ],
  },
];
