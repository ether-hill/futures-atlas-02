...
export interface Scene {
  ...
  sound: Partial<Record<"wind" | "drone" | "bells" | "rain" | "hum", number>>;
...
export const HOME_SCENE: Scene = {
  sound: { drone: 0.35, bells: 0.25, hum: 0.15 },
  videoPrompt:
...
export const SCENES: Record<string, Scene> = {
  "dalai-lama": {
    sound: { wind: 0.65, bells: 0.45, hum: 0.25 },
    videoPrompt:
  ...
  sadhguru: {
    sound: { wind: 0.35, drone: 0.45, hum: 0.35 },
    videoPrompt:
  ...
  "pomnyun-sunim": {
    sound: { rain: 0.55, bells: 0.3, wind: 0.2 },
    videoPrompt:
  ...
  "ahmed-el-tayeb": {
    sound: { drone: 0.35, hum: 0.3, wind: 0.25 },
    videoPrompt:
  ...
  "ali-al-sistani": {
    sound: { drone: 0.4, hum: 0.25, wind: 0.3 },
    videoPrompt:
  ...
  "ephraim-mirvis": {
    sound: { bells: 0.2, drone: 0.25, hum: 0.2 },
    videoPrompt:
  ...
  "aga-khan-v": {
    sound: { wind: 0.6, drone: 0.3, bells: 0.15 },
    videoPrompt:
  ...
  "bartholomew-i": {
    sound: { wind: 0.4, bells: 0.4, hum: 0.2 },
    videoPrompt:
  ...
  kirill: {
    sound: { wind: 0.45, bells: 0.5, drone: 0.3 },
    videoPrompt:
  ...
  "tawadros-ii": {
    sound: { wind: 0.5, hum: 0.3, drone: 0.25 },
    videoPrompt:
  ...
  "dallin-oaks": {
    sound: { wind: 0.45, drone: 0.25, bells: 0.15 },
    videoPrompt:
  ...
  "enoch-adeboye": {
    sound: { drone: 0.35, hum: 0.35, rain: 0.2 },
    videoPrompt:
  ...
  "universal-house-of-justice": {
    sound: { wind: 0.3, bells: 0.25, drone: 0.3 },
    videoPrompt:
  ...
  "kuldeep-singh-gargaj": {
    sound: { hum: 0.35, drone: 0.3, bells: 0.25 },
    videoPrompt:
